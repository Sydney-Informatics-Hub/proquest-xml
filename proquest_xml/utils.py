...
def concordance_dataframe(df, word_list, width=79, lines_per_text=25):
    """
    ...
    word_list: list of strings generated by enter_query() or a
        list of strings that has been manually generated by the user.
    width: maximum number of characters for each keyword in context
    lines_per_text: maximum number of matches returned per text
    ...
    def concordance_object(row):
        ...
        for word in word_list:
            list_object = row.concordance_list(word, width=width, lines=lines_per_text)
